      ...
      <div className={styles.post}>
        ...
        <div className={styles.textContainer}>
          ...
          <p className={styles.postDesc}>
            My Blog is a modern blog platform where users can write, publish, and manage posts with ease.
            Whether you&apos;re a developer, writer, or storyteller, My Blog gives you the tools to express your ideas through a clean and responsive interface.
          </p>
